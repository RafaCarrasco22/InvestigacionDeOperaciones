...
public class SimplexFrame extends JFrame{
    ...
    public SimplexFrame(){
        ...
        ok.addActionListener(new ActionListener() {
            ...
            java.util.logging.Logger.getLogger(SimplexFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, e);
        }
            }
        });
        btnRegresar = new JButton("Solve");
        solve = new Imagen("/img/equal.png");
